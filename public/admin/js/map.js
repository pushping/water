...
$(".map_dev_list ul li").each(function(i,o){
    $(o).click(function(e){
        ...
        var _msg = _this.find(".dev-menu-mes");
        
        if(_msg.nextAll('span').length==0){
            _msg.after("<span class=\"pull-right select_right\" onclick=\"map_dev_search(event)\"><i class=\"fa fa-indent\"><span>")
            //_msg.after("<span class=\"pull-right select_right\"><i class=\"fa fa-indent\"><span>")
            var device_type = _msg.find("input[name=device_type]").val();
