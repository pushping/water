    ...
    methods: {
        ...
        get_DeviceData:function()
        {
            ...
            ajax.post(url,{area_id:this.area_id,},function(res){
                if(res.status=="ok")
                {
                   $("#normal").html(res.data.count.normal);
                   $("#alarm").html(res.data.count.alarm);
                   $("#outline").html(res.data.count.outline);
                   $("#init").html(res.data.count.init);
                   $("#deviceCount").html(res.data.count.count);
                ...
                {   
                   ...
                   $("#smokeTotal_val").html(allcount);
                    ...
                    $.each(res.message.alarmchat,function(i,o){
                        ...
                        $("#"+i+"_pie").attr('data-percent',piechat)
